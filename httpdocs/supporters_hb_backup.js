...
const customConfigObject = { //price buckets as set up in Massarius Ad Manager
  "buckets" : [{
    ...
    const Header_tag = true
    const MPU_ATF_tag = true
    const MPU_BTF_tag = false
    const MPU_BTFV1_tag = false
    const MPU_Native_BTF = true
...
///13436254/Supporters_Native_BTF
{
